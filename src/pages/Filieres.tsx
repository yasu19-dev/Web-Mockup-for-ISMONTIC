...
export function Filieres() {
  const filieres = [
    ...
    },
    {
      ...
      duration: '2 ans',
      niveau: 'Technicien Spécialisé',
      description: 'Formation spécialisée dans les systèmes de paiement électronique et la sécurité des transactions.',
      modules: [
        'Systèmes de paiement électronique',
        'Cartes bancaires et technologies EMV',
        'Protocoles de sécurité (SSL, TLS, 3D Secure)',
        'Cryptographie appliquée',
        'Réglementation bancaire',
        'Développement d\'applications monétiques',
      ],
      debouches: [
        'Technicien Monétique',
        'Gestionnaire de transactions électroniques',
        'Consultant en moyens de paiement',
        'Intégrateur de solutions bancaires',
      ],
      color: '#9C27B0',
    },
  ];
